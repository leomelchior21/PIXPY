...
export function EmptyLineReward({ top, bottom }: EmptyLineRewardProps) {
  return (
    <section className="print-reward empty-line-reward" aria-label="Visible blank line between TOP and BOTTOM" aria-live="polite" tabIndex={0}>
      ...
      <div className="clear-airspace" aria-label="Blank output line">
        <i aria-hidden="true" />
